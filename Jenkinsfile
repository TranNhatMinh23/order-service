  ...
  steps {
   ...
   stage('Check code coverage') {
      ...
      steps {
          ...
          sh 'docker build -t 0914818516/order-service:${VERSION} .'
          sh 'docker push 0914818516/order-service:${VERSION}'
      }
    } 
    ...
    stage('Update Image Tag in GitOps') {
      steps {
        ...
        script {
       sh '''
          sed -i "s/image:.*/image: 0914818516\\/order-service:${VERSION}/" aws/order-manifest.yml
        '''
